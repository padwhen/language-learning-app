    ...
    return (
        <div className="min-h-[250px] md:h-[350px] shadow-md">
            <header className="mt-2 ml-2 flex flex-col sm:flex-row justify-between items-center">
                ...
                <div className="inline-flex gap-1 justify-center items-center rounded border border-gray-300 p-2 mr-2 sm:mr-5 mt-1">
                    ...
                    <span className="text-sm sm:text-base">Get a hint</span>
                </div>
            </header>
