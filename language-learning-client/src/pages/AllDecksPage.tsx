            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 mb-2">All Decks</h1>
                            <p className="text-gray-600">Manage your flashcard decks or create a new one.</p>
                        </div>
                ...
                {displayedDecks.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {displayedDecks.map((deck: any) => (
                            <DockCardLarge key={deck._id} deck={deck} />
                        ))}
                    </div>
                ) : (
                    <div className="text-center py-12">
                        <p className="text-gray-500 mb-4">No decks yet. Create your first deck to get started!</p>
                        <Dialog open={open} onOpenChange={setOpen}>
                            <DialogTrigger asChild>
                                <Button variant="default" className="bg-blue-600 hover:bg-blue-700">
                                    + New Deck
